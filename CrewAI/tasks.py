    ...
    def product_analysis(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Detailed report on product's strengths, market appeal, and suggestions for improvement."
        )
    ...
    def competitor_analysis(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Detailed analysis of top 3 competitors, including strategies, market positioning, and comparison with {product_website}."
        )
    ...
    def campaign_development(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Comprehensive marketing campaign strategy with creative content ideas."
        )
    ...
    def instagram_ad_copy(self, agent):
        return Task(
            description=dedent("""\
                ...
                """),
            agent=agent,
            expected_output="Three options for Instagram ad copy that are engaging, informative, and persuasive."
        )
    ...
    def take_photograph_task(self, agent, copy, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Three creative photograph descriptions for an Instagram post, each capturing the audience's attention."
        )
    ...
    def review_photo(self, agent, product_website, product_details):
        return Task(
            description=dedent(f"""\
                ...
                """),
            agent=agent,
            expected_output="Three reviewed photograph options, each described in detail according to the provided examples."
        )
